...
import (
	...
	v1 "github.com/bks1989/k8s-controller-custom-resource/pkg/apis/samplecrd/v1"
	scheme "github.com/bks1989/k8s-controller-custom-resource/pkg/client/clientset/versioned/scheme"
...
func (c *networks) Delete(ctx context.Context, name string, options *metav1.DeleteOptions) error {
...
func (c *networks) DeleteCollection(ctx context.Context, options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
